				...
				while (1)
				{
					if (rescueBotCount < BOT_COUNT)
					{
					  // Play-mode : short pulse for 500 msec
						...
						if (rescueSoundValue > 80) //if there is a rescue-bot around making a noise
						{
					...
					{
						PlayTone(1184, 3000); //Once rescued play a sound for 3 secs to kick the rescue bots into disperse mode.
